...
import { ChevronLeft, ChevronRight, X, Heart, Sparkles, Star, Flame, Palette } from 'lucide-react'
    ...
    <section className="relative pb-24 lg:pb-32 bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 pt-24 lg:pt-32">
        ...
        <motion.h1
          ...
          className="text-5xl lg:text-7xl font-bold text-center text-purple-900 mb-16 lg:mb-24"
        >
          My AI Version
        </motion.h1>
